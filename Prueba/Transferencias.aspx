<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Transferencias.aspx.cs" Inherits="Prueba.Transferencias" %>
      ...
      <nav class="navbar navbar-default" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="Transferencias.aspx">Transferencias Electronicas</a></li>
      ...
      <div class="row">
        <div class="col-md-4 col-md-offset-4"> 
            <form id="form1" runat="server" class="desplegable">                
                <div class="form-group">                  
                  <h3><b><asp:Label ID="Label3" runat="server">TRANSFERENCIAS</asp:Label></b></h3>
                </div>

                <div class="form-group">                                        
                    <asp:Label ID="Label1" runat="server"> NUMERO DE CUENTA DESTINO</asp:Label>
                    <asp:TextBox ID="txtCuentaDestino" runat="server" CssClass ="form-control"></asp:TextBox>
                </div>
                <div class="form-group">
                    <asp:Label ID="Label2" runat="server"> MONTO A TRANSFERIR </asp:Label>
                    <asp:TextBox ID="txtMonto" runat="server" CssClass ="form-control"></asp:TextBox>
                </div>
                <div class="form-group">
                    <asp:Button ID="btnTransferir" runat="server" Text="Transferir" class="btn btn-primary"/>
                </div>
            </form>
        </div>
      </div>
