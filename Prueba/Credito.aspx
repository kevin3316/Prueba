<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Credito.aspx.cs" Inherits="Prueba.Credito" %>
      ...
      <nav class="navbar navbar-default" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="Credito.aspx">Realizar Credito</a></li>
    ...
    <div class="container"> 
      <div class="row">
        <div class="col-md-4 col-md-offset-4"> 
            ...
            <h1>CREDITO</h1>
                <div class="form-group">
                    <asp:Label ID="Label1" runat="server"> NUMERO DE CUENTA A ACREDITAR </asp:Label>
                    <asp:TextBox ID="txtCuentaDestino" runat="server" CssClass ="form-control"></asp:TextBox>
                </div>
                <div class="form-group">
                    <asp:Label ID="Label2" runat="server"> MONTO DEL CREDITO </asp:Label>
                ...
                <div class="form-group">
                    <asp:Button ID="btnCredito" runat="server" Text="Realizar Credito" class="btn btn-primary"/>
                </div>               
            </form>
        </div>
      </div>
